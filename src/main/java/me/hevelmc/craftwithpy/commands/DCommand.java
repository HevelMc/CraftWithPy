...
/**
 * This class allows you to register a command without the plugin.yml and to dynamically modify the commandExecutor.
 * @author pelt10
 * @author Hevel
 * @version 1.2
 */
public class DCommand extends BukkitCommand {
    ...
    private void registerCommand(JavaPlugin plugin) {
        ...
        try {
            ...
            commandMap.getClass().getMethod("register", String.class, String.class, Command.class).invoke(commandMap, getName(), plugin.getName(), this);
